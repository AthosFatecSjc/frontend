  ...
  <div class="custom-modal-backdrop">
    <div class="custom-modal-card" style="min-width:340px;max-width:98vw;">
      <div class="custom-modal-header">
        <div>
          <div class="custom-modal-title">Aprovar Usuário</div>
          <div class="custom-modal-subtitle">Tem certeza que deseja aprovar o usuário abaixo?</div>
        </div>
      ...
      <div class="custom-modal-fields">
        <input class="custom-modal-input" :value="user.name" readonly />
        <div class="custom-modal-actions">
          <button type="button" class="custom-modal-btn custom-modal-btn-outlined" @click="$emit('close')">Cancelar</button>
          <button type="button" class="custom-modal-btn custom-modal-btn-green" @click="approve">Aprovar</button>
        </div>
      </div>
    </div>
  </div>
...
.custom-modal-btn-green {
  background: #22c55e;
  color: #fff;
}
.custom-modal-btn-green:hover {
  background: #16a34a;
}
</style>
